...
<head>
    ...
    <!-- Link to your consolidated CSS file -->
...
<div class="container mt-5">
    <h1 class="display-4 text-center">Update Color</h1>
    
    <form action="${pageContext.request.contextPath}/colors/update.do" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="imageFile">Update Color Image</label>
